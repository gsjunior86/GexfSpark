package br.gsj.spark.gexfspark.algorithms.shortestpath
...
object Dijkstra {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val edges_rdd = sc.makeRDD(Array(Edge(1L, 2L, ""), Edge(1L, 4L, ""),
      Edge(2L, 3L, ""), Edge(2L, 4L, ""), Edge(2L, 5L, ""),
      Edge(3L, 5L, ""), Edge(4L, 5L, ""), Edge(4L, 6L, ""),
      Edge(5L, 6L, ""), Edge(5L, 7L, ""), Edge(6L, 7L, "")))
  ...
  def dijkstraBC[VD,ED](g: Graph[VD, ED], origin: VertexId) = {
    
    var g2 = g.mapVertices(
      (vid, vd) => (false, if (vid == origin) 0 else Double.MaxValue,
        List[VertexId]())).mapEdges(x => 1.0)
